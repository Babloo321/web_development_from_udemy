...
//2. GET a specific joke by params id
...
//3. GET a jokes by filtering on the joke type by query params
...
app.put("/jokes/:id", (req, res) => {
  ...
  // jokes.map((joke,index) => {      // it is working fine
  //   if(joke.id === id){
  //     jokes[index] = newJoke;
  //   }
  // });
  ...
  console.log("Completed put function");
  res.json(newJoke);
})
...
app.patch('/jokes/:id', (req, res) => {
  ...
  const findJoke = jokes.find(joke => joke.id === reqId);
  const newJoke = {
    id: reqId,
    jokeText: req.body.text || findJoke.jokeText,
    jokeType: req.body.type || findJoke.jokeType
  }
  const findIndex =jokes.findIndex(joke => joke.id === reqId);
